...
.btn-mario:hover { 
    ...
    font-size: 0.875rem !important;
    background-image: url('img/bloco_mario_pergunta.png');
...
font-size: 0.875rem !important;
background-image: url('img/bloco_mario_moeda.png');
background-color: rgba(0,0,0,0) !important;
border-color: rgba(0,0,0,0) !important;
color: rgba(0,0,0,0) !important;
...
.btn-secondary { 
    ...
    color: #ffffff;
    background-color: #9ea9b3 !important;
    border-color: #9ea9b3 !important;
    font-size: 0.875rem !important;
...
.btn-secondary:hover { 
    ...
    color: #ffffff;
    background-color: #869099 !important;
...
/* Paineis e Animação dos Paineis */
#painel_cadastro {
    width: 90%;
    height: max-content;
...
#modal_ftp.fechar_modal_ftp {
    animation-name: fechar_modal;
    animation-duration: .3s;
    animation-fill-mode: forwards;
}

@keyframes fechar_modal {
    0% {
        top: 50%;
        transform: translate(-50%, -50%);
    }
